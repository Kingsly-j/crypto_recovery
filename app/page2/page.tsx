...
/*
  ...
  - Live unconfirmed BTC transactions (BlockCypher)
  - Fade-out trimming
  - Large TX highlighting
  - Address correlation badge
  - Admin-controlled proceed1 → Page 3
*/
...
export default function Page2() {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      // Ensure proceed1 exists (created once only)
